...
const AllHamburger = ({ hamburgers, categories }) => {
    ...
    <div className='col-span-4'>
      <div className='overflow-x-auto max-h-[500px] overflow-y-auto'>
        <table className='table w-full text-center'>
          ...
          <tbody>
            {!isEmpty(hamburgers) &&
              map(hamburgers, (hamburger) => (
                <tr key={hamburger._id}>
                  <td className='border px-8 py-4'>{hamburger.name.slice(0, 20)}</td>
                  <td className='border px-8 py-4'>{hamburger.details?.slice(0, 20)}...</td>
                  <td className='border px-8 py-4'>{hamburger.categoryId}</td>
                  <td className='border px-8 py-4'>{map(hamburger.price, (price) => price).join(', ')}</td>
                  <td className='border px-8 py-4'>
                    <Link href={`admin/hamburger/update/${hamburger._id}`}>
