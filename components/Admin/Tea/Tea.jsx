        ...
        <table className='table w-full text-center'>
          ...
          <tbody>
            {!isEmpty(teas) &&
              map(teas, (tea) => (
                <tr key={tea._id}>
                  <td className='border px-8 py-4'>{tea.name.slice(0, 20)}</td>
                  <td className='border px-8 py-4'>{tea.details?.slice(0, 20)}...</td>
                  <td className='border px-8 py-4'>{tea.categoryId}</td>
                  <td className='border px-8 py-4'>{map(tea.price, (price) => price).join(', ')}</td>
                  <td className='border px-8 py-4'>
                    <Link href={`admin/tea/update/${tea._id}`}>
